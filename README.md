...
| 10   | Applikation ist getestet und läuft.   | Benutzer überprüft die Dokumentation.                    | Die Dokumentation ist vollständig und klar, und das Projekt kann ohne Probleme übergeben werden. |
